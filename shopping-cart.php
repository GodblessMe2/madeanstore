      ...
      <div class="row">
          ...
          <div class="m-l-25 m-r--38 m-lr-0-xl">
            <div class="wrap-table-shopping-cart">
              <table class="table-shopping-cart">
                ...
                <tr class="table_row">
                  <td class="column-1">
                    <div class="how-itemcart1"><img alt="IMG" src="images/item-cart-04.jpg"></div>
                  </td>
                  ...
                  <td class="column-4">
                    <div class="wrap-num-product flex-w m-l-auto m-r-0">
                      ...
                      </div><input class="mtext-104 cl3 txt-center num-product" name="num-product1" type="number" value="1">
            ...
            <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
              <div class="flex-w flex-m m-r-20 m-tb-5">
                <input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 m-tb-5" name="coupon" placeholder="Coupon Code" type="text">
        ...
        <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
          <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
              ...
              <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                ...
                <div class="p-t-15">
                  ...
                  <div class="bor8 bg0 m-b-12">
                    <input class="stext-111 cl8 plh3 size-111 p-lr-15" name="state" placeholder="State / country" type="text">
                  </div>
                  <div class="bor8 bg0 m-b-22">
                    <input class="stext-111 cl8 plh3 size-111 p-lr-15" name="postcode" placeholder="Postcode / Zip" type="text">
                  </div>
                  <div class="flex-w">
            ...
            </div><button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</button>
          </div>
        </div>
      </div>
    </div>

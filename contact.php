...
<?php include("inc/header.php");?>
         ...
         <div class="flex-w flex-tr">
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
               <form action="handler/contact.php" method="POST">
                  ...
                  <div class="bor8 m-b-20 how-pos4-parent"><input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" name="email" placeholder="Your Email Address" type="text"> <img alt="ICON" class="how-pos4 pointer-none" src="images/icons/icon-email.png"></div>
                  <div class="bor8 m-b-30">
                     <textarea class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" name="msg" placeholder="How Can We Help?"></textarea>
                  </div><button class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" name="submit">Submit</button>
               </form>
            </div>
            <div class="size-210 bor10 flex-w flex-col-m p-lr-93 p-tb-30 p-lr-15-lg w-full-md">
               ...
               <div class="flex-w w-full">
                  ...
                  <div class="size-212 p-t-2">
                     ...
                     <p class="stext-115 cl1 size-213 p-t-18"><a class="__cf_email__" data-cfemail="92f1fdfce6f3f1e6d2f7eaf3ffe2fef7bcf1fdff" href="https://preview.colorlib.com/cdn-cgi/l/email-protection">[email&#160;protected]</a></p>
                  </div>
               </div>
            </div>
         </div>
   ...
   <div class="map">
      <div class="size-303" data-draggable="1" data-map-x="40.691446" data-map-y="-73.886787" data-pin="images/icons/pin.png" data-scrollwhell="0" data-zoom="11" id="google_map"></div>
